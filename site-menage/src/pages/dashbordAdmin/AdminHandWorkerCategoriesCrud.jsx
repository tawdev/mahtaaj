                  ...
                  <div className="category-icon">
                    {category.image ? (
                      <img
                        ...
                        onError={(e) => {
                          e.target.style.display = 'none';
                          e.target.parentNode.innerHTML = category.icon ? `<i class="${category.icon}"></i>` : '<i class="fas fa-tools"></i>';
                        }}
                      />
                    ) : (
                      category.icon ? <i className={category.icon}></i> : <i className="fas fa-tools"></i>
                    )}
                  </div>
