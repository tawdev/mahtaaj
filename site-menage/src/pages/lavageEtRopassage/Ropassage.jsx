                          ...
                          <div className="ropassage-vetements-sub-options">
                            ...
                            <div className="ropassage-sub-options-container">
                              ...
                              <div className="ropassage-sub-option-item">
                                ...
                                {vetementsDetails[item.id]?.option2?.selected && (
                                  <div className="ropassage-jaket-materials-group">
                                    <div className="ropassage-jaket-materials-title">
                                      {t('ropassage_page.select_jaket_material', 'Sélectionnez le type de matériau')}:
                                    </div>
                                    <div className="ropassage-jaket-materials-container">
                                      {Object.keys(jaketMaterialPrices).map((material) => {
                                        ...
                                        const quantity = materials[material] || 0;
                                        const materialName = t(`ropassage_page.jaket_material_${material}`, material.charAt(0).toUpperCase() + material.slice(1));
                                        return (
                                          <div key={material} className="ropassage-jaket-material-item">
                                            <button
                                              type="button"
                                              className={`ropassage-jaket-material-btn ${isSelected ? 'ropassage-jaket-material-btn-selected' : ''}`}
                                            ...
                                            >
                                              ...
                                              <span className="ropassage-jaket-material-price">
                                                {jaketMaterialPrices[material]} DH
                                              </span>
                                            </button>
                                            {isSelected && (
                                              <>
                                                <div className="ropassage-jaket-quantity-group">
                                                  <label className="ropassage-quantity-label">
                                                    {t('ropassage_page.quantity', 'Nombre de pièces')}:
                                                  </label>
                                                  <input
                                                ...
                                                {quantity > 0 && (
                                                  <div className="ropassage-jaket-material-subtotal">
                                    ...
                                    {Object.keys(vetementsDetails[item.id]?.option2?.materials || {}).length > 0 && (
                                      <div className="ropassage-jaket-total">
                                        {t('ropassage_page.total', 'Total')}: {
